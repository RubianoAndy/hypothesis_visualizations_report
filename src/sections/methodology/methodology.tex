\section{Metodología}
    ...
    \subsection{Conjunto de datos}
        ...
        \begin{table}[H]
            ...
            \begin{center}
                \begin{tabular}{|l|l|>{\raggedright\arraybackslash}p{3.5cm}|}
                    \hline
    ...
    \subsection{Contrastes robustos a la heterocedasticidad}
        ...
        Dado que la segunda hipótesis rechaza la igualdad de varianzas,
        el ANOVA clásico y el post-hoc de Tukey no son adecuados, por tanto, 
        se emplean métodos robustos: el ANOVA de Welch, que pondera los grupos
        mediante $w_i=n_i/s_i^2$ \cite{welch1951comparison}, y el post-hoc de
        Games-Howell, que utiliza el error estándar de Welch y los grados de
        libertad ajustados por Welch-Satterthwaite \cite{games1976pairwise}.
